...
Window {
    ...
    Item {
        ...
        // Numeric speed (cm/s) with display smoothing
        Text {
            id: speedText
            
            // Display value that smoothly animates
            ...
            // Smooth animation for display value changes
            ...
            // Update display value when bridge speed changes
            Connections {
                target: bridge
            ...
            // Initialize display value on startup
            Component.onCompleted: {
                displaySpeed = Math.max(0, bridge.speed)
            }
        }
    ...
    Item {
        ...
        // Battery percentage with display smoothing
        Text {
            id: batteryText
            ...
            Component.onCompleted: {
                displayBattery = Math.max(0, Math.min(100, bridge.battery))
            }
        }
    ...
    Item {
        ...
        // Display battery level with smoothing
        ...
        Component.onCompleted: {
            displayBatteryLevel = Math.max(0, Math.min(bridge.battery, 100))
        }
    ...
    Rectangle {
        ...
        Column {
            ...
            Text { 
                text: "Raw speed: " + Math.max(0, bridge.speed).toFixed(1) + " cm/s"
                color: "white"
                font.pixelSize: 16 
            }
            Text { 
                text: "Display speed: " + speedText.displaySpeed.toFixed(1) + " cm/s"
                color: "yellow"
                font.pixelSize: 16 
            }
            Text { 
